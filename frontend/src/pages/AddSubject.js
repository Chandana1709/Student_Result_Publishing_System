...
const AddSubject = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      if (!subjectName || !subjectCode || !year || !semesterNo || !selectedDepartment) {
  ...
  const validateSemesterNo = (value) => {
        ...
        <form onSubmit={handleSubmit} style={{ width: '100%' }}>
          ...
          <div style={{ marginBottom: '16px', width: '100%' }}>
            ...
            <TextField
              ...
              error={semesterNo !== '' && !validateSemesterNo(semesterNo)}
              helperText={
                semesterNo !== '' && !validateSemesterNo(semesterNo)
